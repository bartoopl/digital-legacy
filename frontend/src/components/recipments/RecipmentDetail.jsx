    ...
    useEffect(() => {
        const fetchRecipientAndMedia = async () => {
            try {
                ...
                // If recipient has assigned media, fetch each media item
                ...
                setError(err.response?.data?.message || 'Error fetching recipient details');
                setLoading(false);
            }
        };
            ...
            <div className="max-w-4xl mx-auto">
                <div className="bg-white rounded-lg shadow overflow-hidden">
                    <div className="px-6 py-4">
                        ...
                        <div className="mb-6">
                            <h2 className="text-xl font-bold mb-3">Assigned Media</h2>
